...
| england-2013 | England, J.L. (2013). "Statistical physics of self-replication." *J. Chem. Phys.* 139:121923. arXiv:1209.1179 | Fluctuation-theorem lower bound on heat dissipated in self-replication; driven matter may restructure to dissipate more ("dissipative adaptation"). CONTESTED in strong form: this 2013 bound is cited and directly rebutted by kolchinsky-2024 (no universal dissipation↔replicator-rate relationship); for the Darwinian-equivalence framing see england-2016 | physics / origin-of-life | 2026-06-15 (existence corroborated via kolchinsky-2024 citation) |
| kolchinsky-2024 | Kolchinsky, A. (2024). "Thermodynamic dissipation does not bound replicator growth and decay rates." arXiv:2404.01130 | A universal relationship connecting thermodynamic dissipation to replicator growth/decay rates "cannot exist in principle" (replication and decay-into-waste are independent physical processes) — a direct theoretical rebuttal of the strong dissipation-adaptation claim | physics / statistical mechanics | 2026-06-15 (live-verified, arxiv abstract) |
| england-2016 | Perunov, N., Marsland, R.A. & England, J.L. (2016). "Statistical Physics of Adaptation." *Phys. Rev. X* 6:021036 (arXiv:1412.1875) | Driven many-particle systems tend to self-organize toward reliable absorption/dissipation of work; the paper frames adaptation as BOTH natural selection and physics — for replicators the thermodynamic account folds into the Darwinian one rather than replacing it (so NOT a distinct mechanism — the bound on the lens) | physics / adaptation | 2026-06-15 (live-verified, arxiv abstract) |
| dewar-2009 | Dewar, R.C. (2009). "Maximum Entropy Production as an Inference Algorithm that Translates Physical Assumptions into Macroscopic Predictions: Don't Shoot the Messenger." *Entropy* 11(4):931–944. DOI:10.3390/e11040931 | MEPP recast as Jaynes' MaxEnt inference algorithm with no physical content — disagreement with experiment falsifies the physical assumptions, not MEPP; i.e. MEPP is not established as a physical law | physics / inference | 2026-06-15 (live-verified, web) |
